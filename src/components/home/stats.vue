        ...
        <v-layout wrap align-center justify-center row fill-height>
            <v-flex xs12 sm5 md6 lg6 xl6 class="pa-5">
               <p class="google-font mb-1" style="font-weight: 350;color: #616161;font-size:200%"><b>On the edge of  
                    <span style="color: #1a73e8;">Android, Web</span> and <span style="color: #1a73e8;">Cloud</span></b> 
                </p>
                <p class="google-font mt-3">
                    GDG DevFest Jalandhar brings together people who shape the future of Android, Web and Cloud technologies for 2 days of sessions, workshops and networking. Described by many as 'Google I/O of Jalandhar', our team creates DevFest to be the best place for inspiration and experience sharing.
                </p>
                ...
                <v-layout row wrap class="px-5">
                    <v-flex xs6>
                        <p class="google-font mb-0" style="font-weight: 350;color: #616161;font-size:300%"><b>  
                            <span style="color: #1a73e8;">300+</span></b> 
                        </p>
                        <p class="google-font">
                            Attendeess
                        </p>
                    ...
                    <v-flex xs6>
                        <p class="google-font mb-0" style="font-weight: 350;color: #616161;font-size:300%"><b>  
                            <span style="color: #1a73e8;">10+</span></b> 
                        </p>
                        <p class="google-font">
                            Sessions
                        </p>
